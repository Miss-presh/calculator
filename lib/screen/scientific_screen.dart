...
class ScientificScreen extends StatefulWidget {
  @override
   _ScientificScreenState createState() => _ScientificScreenState();
}
...
class _ScientificScreenState extends State<ScientificScreen> {
  ...
  final List<List<CalculatorButton>> _buttonLayout = [
    [
      CalculatorButton(text: "2nd", value: "2nd", type: ButtonType.function, color: Colors.blue),
      CalculatorButton(text: "deg", value: "deg", type: ButtonType.function, color: Colors.blue),
      CalculatorButton(text: "sin", value: "sin", type: ButtonType.function, color: Colors.blue),
      CalculatorButton(text: "cos", value: "cos", type: ButtonType.function, color: Colors.blue),
    ],
    [
      ...
      CalculatorButton(text: "CE", value: "CE", type: ButtonType.utility, color: Colors.red[400]),
    ],
    [
      CalculatorButton(text: "9", value: "(", type: ButtonType.number),
      CalculatorButton(text: "8", value: ")", type: ButtonType.number),
      CalculatorButton(text: "7", value: "9", type: ButtonType.number),
